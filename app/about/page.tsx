...
export default function AboutPage() {
  ...
  const skillGroups = [
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "Database Architecture (MySQL)",
          level: "85%",
          color: "bg-blue-600",
        },
      ],
  ...
  const careerTimeline = [
    {
      year: "2026",
      title: "Tech Team Lead @ Clever",
      desc: "قيادة الفرق التقنية لبناء حلول برمجية متكاملة ومبتكرة.",
    },
    {
      year: "2025",
      title: "Backend Developer @ Rantisi Hospital",
      desc: "تطوير وهندسة الأنظمة الخلفية في بيئة طبية معقدة.",
    },
    {
      year: "2023",
      title: "Vue.js Developer",
      desc: "بناء واجهات تفاعلية متطورة وتجارب مستخدم احترافية.",
    },
    {
      year: "2022",
      title: "Intensive Training",
      desc: "إتمام 8 كورسات تخصصية وجاهية في علوم البرمجة.",
    },
    {
      year: "2021",
      title: "The Beginning",
      desc: "بدء رحلة تخصص هندسة أنظمة الحاسوب والشغف التقني.",
    },
  ];
      ...
      <section className="relative pt-24 md:pt-36 pb-20 px-6 text-center overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-8">
            <a
              href="https://www.linkedin.com/in/farah-bader-528994379"
              target="_blank"
            ...
            <a
              href="https://github.com/Farah-bader22/dandecode-platform"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skillGroups.map((group, idx) => (
            ...
            >
              <h3 className="text-xs font-black text-indigo-600 mb-10 uppercase tracking-[0.2em]">
                {group.category}
              </h3>
